...
class CoBenchEuroSATS1(EuroSAT):
    url = "https://huggingface.co/datasets/wangyi111/Copernicus-Bench/resolve/main/l2_eurosat_s1s2/eurosat_s1.zip"
    base_dir = 'all_imgs'
